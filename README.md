# NE-02 Voting Procedures Dashboard

NE-02 (Bacon retiring; Denise Powell D vs Brinker Harding R)
...
```bash
# In Apprentice101/ne02-dashboard repo:
git add .
git commit -m "Deploy NE-02 dashboard"
